...
const Projects = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Wasim Samnani | Projects</title>
        <meta charset="UTF-8" />
        <meta
          name="viewport"
        ...
        <meta
          ...
          content="https://github.com/Wasimsamnani/Portfolio-website/projects.html"
        />
        <meta property="og:title" content="Wasim Samnani | Projects" />
        <meta
        ...
        <meta name="twitter:title" content="Wasim Samnani | Projects" />
        <meta
        ...
        <meta
          ...
          content="https://github.com/Wasimsamnani/Portfolio-website/projects.html"
        />
        <meta name="application-name" content="Wasim Samnani | Projects" />
        <meta
          name="twitter:site"
          content="https://github.com/Wasimsamnani/Portfolio-website/projects.html"
        />
        <meta name="apple-mobile-web-app-title" content="Wasim Samnani | Projects" />
        <meta
          name="summary"
          content="An open source project aimed at providing free and beautiful templates to everyone for building their portfolio websites and showcase their work to the world."
        />
      ...
      <div
        className={`${styles["main-container"]} ${styles["pt-5"]}`}
        ...
        <section className={`${styles["main-section"]}`}>
          <div className={styles["row"]}>
              ...
              >
                ...
                <g id={styles["Woman__x2F__Chair__x2F__Screen"]}>
                  ...
                  <g id={styles["back-arm"]}>
                    ...
                    z
                    <path
                      id={styles["lowervackarm"]}
                      fill="#F68E5A"
                      d="M669 361c4 1 13 4 15 2s8-4 11-2l42 25v-15s-46-22-51-19l-17 9z"
                    ></path>
                  </g>
                  <g id={styles["womanscreen"]} className="womscreenmove"></g>
                  <g id={styles["Woman"]}>
                ...
                <g id={styles["flowerpot"]}>
                  <g id={styles["plants"]}></g>
                </g>
                <g id={styles["Man__x2F__chair__x2F__screen"]}>
                  <path
                    id={styles["chairbackbar"]}
                    fill="#52057B"
            ...
            <div className={`${styles["project-heading"]}`}>
              ...
              >
                <h2
                  className={`${styles["main-heading"]} ${styles["mb-0"]} ${styles["projects_head"]}`}
                >
                  My <span className={styles["my_projects"]}>Projects</span>
                </h2>
                <p
                  className={`${styles["pre-heading"]} ${styles["font-weight-bolder"]} ${styles["mb-0"]} ${styles["mt-3"]} ${styles["text-center"]} ${styles["animate__animated"]} ${styles["animate__zoomIn"]} ${styles["animate__delay-2s"]}`}
                >
      ...
      <div className={styles["project-box"]} style={{ padding: "20px;" }}>
        <div className={`${styles["page-content"]} ${styles["projectcards"]}`}>
          {data.map((item) => (
            <div
              className={`${styles["column"]} ${styles["skill-card"]} ${styles["card"]}`}
              style={{ margin: "15px" }}
              data-aos="zoom-in-up"
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${item ? item.img : image})`,
                      ...
                      <li>
                        ...
                        >
                          <svg
                            ...
                            className={`${styles["feather"]} ${styles["feather-monitor"]}`}
                          >
                            <rect
                              x="2"
                              y="3"
